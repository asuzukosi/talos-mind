...
model_id = "fracapauano/robot_learning_act_example_model"
...
preprocess, postprocess = make_pre_post_processors(policy_cfg=model.config, dataset_meta=dataset_metadata.stats)
# define the configuration for the follower robot
follower_port = 5000
...
robot_cfg = SOFollowerConfig(port=follower_port, id=follower_id, camera_config=camera_config)
